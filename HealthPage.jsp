...
<body style="display: flex; justify-content: center; margin: 0px;">
    ...
    <div style="width: 80vw; display: flex; flex-direction: column; align-items: center;">
        ...
        <main style="display: flex; width: 80vw; justify-content: space-around; margin-top: 70px;">
        	...
        	<div style="display: flex; border: solid 0.5px; color: #FED14F; width: 30vw; padding: 20px; align-items: center;">
            	<div style="display: flex; flex-direction: column; align-items: center;">
            		<img src="images/말왕.jpg" alt="말왕TV" style="border: solid 1px; border-radius: 5%; width: 10vw;">
            	...
            	<div style="display: flex; flex-direction: column; color:black; margin-left: 15px;">
            		...
            		<button style="background-color:#FED14F; cursor: pointer;">youtube 바로가기</button></a>
            	</div>
            </div>
            
            <div style="display: flex; border: solid 0.5px; color: #FED14F; width: 30vw; padding: 20px; align-items: center;">
            	<div style="display: flex; flex-direction: column; align-items: center;">
            		<img src="images/흑자.jpg" alt="흑자헬스" style="border: solid 1px; border-radius: 5%; width: 10vw;">
            		<p style="font-weight: bold; cursor: default; color: black;">
            			흑자헬스
            		</p>
            	</div>
            	<div style="display: flex; flex-direction: column; color:black; margin-left: 15px;">
            		<p style="font-weight: bold; cursor: default;">
            			실(Loss)없이 운동하자! <br> 흑자헬스(Surplus Health)
            		</p>
        ...
        <main style="display: flex; width: 80vw; justify-content: space-around; margin-top: 30px;">
        	...
        	<div style="display: flex; border: solid 0.5px; color: #FED14F; width: 30vw; padding: 20px; align-items: center;">
            	<div style="display: flex; flex-direction: column; align-items: center;">
            		<img src="images/지피티.jpg" alt="지피티" style="border: solid 1px; border-radius: 5%; width: 10vw;">
            		<p style="font-weight: bold; cursor: default; color:black;">
            			지피티
            		</p>
            	</div>
            	<div style="display: flex; flex-direction: column; color:black; margin-left: 15px;">
            		<p style="font-weight: bold; cursor: default;">
            			맛있게 먹으면서 운동하자! <br> 운동정보와 대리만족을 드리는 <br> 지피티입니다:)
            		</p>
            ...
            <div style="display: flex; border: solid 0.5px; color: #FED14F; width: 30vw; padding: 20px; align-items: center;">
            	<div style="display: flex; flex-direction: column; align-items: center;">
            		<img src="images/피지컬갤러리.jpg" alt="피지컬갤러리" style="border: solid 1px; border-radius: 5%; width: 10vw;">
            		<p style="font-weight: bold; cursor: default; color:black;">
            			피지컬갤러리
            		</p>
            	</div>
            	<div style="display: flex; flex-direction: column; color:black; margin-left: 15px;">
            		<p style="font-weight: bold; cursor: default;">
            			재밌고 유익한 체형교정과 <br> 재활 정보를 알려주는 <br> 빡빡이 아저씨를 볼 수 있는 채널. <br> (이하생략)
            		</p>
        ...
        <main style="display: flex; width: 80vw; justify-content: space-around; margin-top: 30px;">
        	...
        	<div style="display: flex; border: solid 0.5px; color: #FED14F; width: 30vw; padding: 20px; align-items: center;">
            	<div style="display: flex; flex-direction: column; align-items: center;">
            		<img src="images/김종국.jpg" alt="김종국" style="border: solid 1px; border-radius: 5%; width: 10vw;">
            		<p style="font-weight: bold; cursor: default; color:black;">
            			GYM JONG KOOK
            		</p>
            	</div>
            	<div style="display: flex; flex-direction: column; color:black; margin-left: 15px;">
            		<p style="font-weight: bold; cursor: default;">
            			안녕하세요 김종국.. <br> 아니 GYM 종국 ㅎ 입니다 ㅎ <br>
            			자격증 이라곤 이 몸땡이 뿐인 ㅎ <br>
            			그냥 운동 좋아하고 <br> 오래 한 ㅎ 동네 아저씨 ㅎ <br>
            			우리 다함께 건강한 대한민국을 위해서 쭉 함 달려봅시다!! 💪 
            		</p>
			...
			<div style="display: flex; border: solid 0.5px; color: #FED14F; width: 30vw; padding: 20px; align-items: center;">
            	<div style="display: flex; flex-direction: column; align-items: center;">
            		<img src="images/보운채.jpg" alt="보통사람을 위한 운동채널" style="border: solid 1px; border-radius: 5%; width: 10vw;">
            		<p style="font-weight: bold; cursor: default; color:black;">
            			보통사람을 위한 운동채널
            		</p>
            	</div>
            	<div style="display: flex; flex-direction: column; color:black; margin-left: 15px;">
            		<p style="font-weight: bold; cursor: default;">
            			보통의, 보통에 의한, 보통을 위한 <br> 운동정보를 드립니다.
            		</p>
        ...
        <main style="display: flex; width: 80vw; justify-content: space-around; margin-top: 30px;  margin-bottom: 70px;">
       		...
       		<div style="display: flex; border: solid 0.5px; color: #FED14F; width: 30vw; padding: 20px; align-items: center;">
            	<div style="display: flex; flex-direction: column; align-items: center;">
            		<img src="images/권혁.jpg" alt="권혁TV" style="border: solid 1px; border-radius: 5%; width: 10vw;">
            		<p style="font-weight: bold; cursor: default; color:black;">
            			권혁TV
            		</p>
            	</div>
            ...
            <div style="display: flex; border: solid 0.5px; color: #FED14F; width: 30vw; padding: 20px; align-items: center;">
            	<div style="display: flex; flex-direction: column; align-items: center;">
            		<img src="images/핏블리.jpg" alt="핏블리" style="border: solid 1px; border-radius: 5%; width: 10vw;">
            		<p style="font-weight: bold; cursor: default; color:black;">
            			핏블리
            		</p>
            	</div>
            	<div style="display: flex; flex-direction: column; color:black; margin-left: 15px;">
            		<p style="font-weight: bold; cursor: default;">
            			“운동독학, 누구나 쉽고 전문적으로” <br> 국제트레이너 / 스포츠영양코치 / <br> BJ치즈볼 / 타락헬창 <br>
            			40여개국 세계여행&전문 자격증으로 <br> 탄생한 핏블리 <br> (이하생략)
            		</p>
