...
<body style="display: flex; justify-content: center; margin: 0px;">
    ...
    <div style="width: 80vw; display: flex; flex-direction: column; align-items: center;">
        ...
        <main style="display: flex; width: 80vw; justify-content: space-around; margin-top: 70px;">
            ...
            <div style="display: flex; border: solid 0.5px; color: #FED14F; width: 30vw; padding: 20px; align-items: center;">
            	<div style="display: flex; flex-direction: column; align-items: center;">
            		<img src="images/땅크.jpg" alt="Thankyou BUBU" style="border: solid 1px; border-radius: 50%; width: 10vw;">
            		<p style="font-weight: bold; cursor: default; color:black;">
            			Thankyou BUBU
            		</p>
            	</div>
        ...
        <main style="display: flex; width: 80vw; justify-content: space-around; margin-top: 30px;">
        	...
        	<div style="display: flex; border: solid 0.5px; color: #FED14F; width: 30vw; padding: 20px; align-items: center;">
            	<div style="display: flex; flex-direction: column; align-items: center;">
            		<img src="images/힙으뜸.jpg" alt="힙으뜸" style="border: solid 1px; border-radius: 50%; width: 10vw;">
            		<p style="font-weight: bold; cursor: default; color:black;">
            			힙으뜸
            		</p>
            	</div>
            ...
            <div style="display: flex; border: solid 0.5px; color: #FED14F; width: 30vw; padding: 20px; align-items: center;">
            	<div style="display: flex; flex-direction: column; align-items: center;">
            		<img src="images/써니퍼니.jpg" alt="Sunny Funny Fitness" style="border: solid 1px; border-radius: 50%; width: 10vw;">
            		<p style="font-weight: bold; cursor: default; color:black;">
            			Sunny Funny Fitness
            		</p>
            	</div>
        ...
        <main style="display: flex; width: 80vw; justify-content: space-around; margin-top: 30px;">
        	...
        	<div style="display: flex; border: solid 0.5px; color: #FED14F; width: 30vw; padding: 20px; align-items: center;">
            	<div style="display: flex; flex-direction: column; align-items: center;">
            		<img src="images/비타민.jpg" alt="비타민신지니" style="border: solid 1px; border-radius: 50%; width: 10vw;">
            		<p style="font-weight: bold; cursor: default; color:black;">
            			비타민신지니
            		</p>
            	</div>
			...
			<div style="display: flex; border: solid 0.5px; color: #FED14F; width: 30vw; padding: 20px; align-items: center;">
            	<div style="display: flex; flex-direction: column; align-items: center;">
            		<img src="images/소미핏.jpg" alt="소미핏" style="border: solid 1px; border-radius: 50%; width: 10vw;">
            		<p style="font-weight: bold; cursor: default; color:black;">
            			<br> 소미핏
            		</p>
            	</div>
        ...
        <main style="display: flex; width: 80vw; justify-content: space-around; margin-top: 30px;  margin-bottom: 70px;">
       		...
       		<div style="display: flex; border: solid 0.5px; color: #FED14F; width: 30vw; padding: 20px; align-items: center;">
            	<div style="display: flex; flex-direction: column; align-items: center;">
            		<img src="images/이지은.jpg" alt="이지은 다이어트" style="border: solid 1px; border-radius: 50%; width: 10vw;">
            		<p style="font-weight: bold; cursor: default; color:black;">
            			<br> 이지은 다이어트
            		</p>
            	</div>
