...
<body style="display: flex; justify-content: center;">
    ...
    <div style="width: 80vw; display: flex; flex-direction: column; align-items: center; margin-top: 30px;">
        ...
        <main style="display: flex; flex-direction: column; align-items: center;">
			...
			<% } else { %>
							<div style="display: flex; align-items: center; margin-top: 100px; cursor: default;">
							        	<p><h2><%= username %>님</h2> 환영합니다</p>
							</div>
								
				        	<div style="display: flex;">
				        		<a href="UserUpdate.jsp" style="display: flex; justify-content: center; align-items: center; margin-right: 30px;
